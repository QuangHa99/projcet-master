                    ...
                    <div class="product-left-sidebar">
                        <div class="product-single-sidebar">
                            ...
                            <ul>
                                ...
                                <li style="margin: 5px;">
                                    <form method="get" action="{{ route('Shop.price_sp_thuonghieu') }}">
                                        {{-- @csrf --}}
                                        <input type="hidden" class="g1" name="g1" value="{{$g1}}">
                                        <input type="hidden" class="g2" name="g2" value="{{$g2}}">
                                        <input type="hidden" name="brandid" value="{{$branddk->id}}">
                                        <button type="submit" class="filter_button" style=""><span style="line-height: 25px;">submit</span></button>
                                    </form>
                                </li>
                            </ul>
                        </div>
                        <div class="product-single-sidebar">
                            ...
                            <ul class="product-color-var">
                                ...
                                <li>
                                    ...
                                    <a href="{{ route('Shop.brand', ['id' =>$item->id,]) }}">{{$item->name}}</a>
                                </li>
                                @endforeach
                            </ul>
                    ...
                    <div class="all-gategory-product">
                        <div class="row" style=" margin: 16px;    width: 93%;">
                            @foreach($products as $item)
                                ...
                                if ($item->total_number){
                                    $age = $item->total_rating / $item->total_number;

                                }
                                ?>
                            <ul class="gategory-product col-md-3 col-sm-6 col-xs-12">
                                <li class="gategory-product-list ">
                        ...
                        <div class="box-footer clearfix">
                            <ul class="pagination pagination-sm no-margin pull-right">
                                {{ $products->appends(['g1'=>$g1,'g2'=>$g2,'brandid'=>$branddk->id])->links() }}
                            </ul>
                    </div>
                </div>
            </div>
