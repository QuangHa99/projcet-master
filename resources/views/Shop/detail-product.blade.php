                        ...
                        <div class="col-lg-7 col-md-7 col-sm-8 col-xs-12">
                            <div class="single-product-descirption">
                                ...
                                <div class="single-product-condition">
                                    ...
                                    @endfor
                                   <p style="margin-top: 10px;">Số lượng: <span>{{ $product->stock }}</span></p>
{{--                                    <p>Tình Trạng: <span>{{ ($product->stock >0) ? 'Còn Hàng' : 'Hết Hàng' }}</span></p>--}}
                                </div>
                                <div class="single-product-price">
                                    <p style="font-weight: bold;">Giá: &nbsp;
                                    @if($product->sale==0)
                                        <span class="price">{{number_format($product->price)}} <sup>đ</sup> </span>
                                    @else
                                        <span class="price" style="color: red; font-size: 15px; font-weight: bold">{{number_format($product->sale)}} <sup>đ</sup> </span>
                                        &nbsp;
                                ...
                                <div class="single-product-quantity">
                                    <p class="small-title">Số lượng đặt mua:</p>
                                    <div class="">
                                        <div class="">
                                ...
                                <div class="single-product-color" style=" margin-top: 15px;">
                                    ...
                                    <div class="fb-like" data-href="{{url()->current()}}" data-width="350" data-layout="standard" data-action="like" data-size="large" data-share="true"></div>                                
                                </div>
                                        ...
                                        <form class="form_rating hidden" name="fRatingComment">
                                            ...
                                            <div class="ipt">
                                                ...
                                                <div style="display: flex;margin-bottom: 5px;">
                                                    ...
                                                    <a href="{{route('shop.rating.product',$product->id)}}" class=" btn btn-primary js_rating_product " style="text-align: center">GỬI ĐÁNH GIÁ</a>
                                                </div>
                                            </div>
                                        </form>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('.js_rating_product').click(function (e) {
                ...
                if(email !='' && email.match(mailformat) && number_rating !=''){
                    ...
                    if (conntent && number_rating)
                    {
                        $.ajax({
                            ...
                            if (result.code == 1) {
                                ...
                                alert("Bạn không được phép đánh giá khi bạn chưa từng mua hàng !")
                            }
                        });
                    }
                }else{
                    alert('Bạn chưa chọn số sao hoặc chưa nhập email');
                }
            });
        });
        ...
        function addToCart() {
            ...
            var value = $('#slsp').val().replace(/^\s\s*/, '').replace(/\s\s*$/, '');
            var intRegex = /^\d+$/;
            if (quantity <= 0 || !intRegex.test(value)) {
            ...
            $.ajax({
                ...
                error: function (e) { // lỗi nếu có
                    ...
                    alert("Xin lỗi! Số lượng sản phẩm này không còn đủ như yêu cầu của quý khách");
                }
            });
