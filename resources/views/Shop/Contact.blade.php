                                        ...
                                        <div class="type-of-text">
                                            <div class="form-group primary-form-group">
                                                ...
                                                @if ($errors->has('content'))
                                                    <span class="invalid-feedback" role="alert" style="color:red;">{{ $errors->first('content') }}</span>
                                                @endif
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    <button type="submit" name="submit" id="sendMessage" class="btn btn-primary" style="width: 267px; margin-top: -45px;"> Gửi </button>
                            </form>
                            <!-- CONTACT-FORM END -->
                        </div>
                    </div>
