...
//danh sách brand
Route::get('brand/id={id}', 'ShopController@brand')->name('Shop.brand');
// chi tiết sản phẩm
...
//gia
Route::get('san-pham/pricedanhmuc', 'ShopController@giaCa')->name('Shop.sptg');
//
Route::get('sanpham/pricethuonghieu', 'ShopController@giaCaThuonghieu')->name('Shop.price_sp_thuonghieu');
